...
|-----------|------|------------|
| **OOM Protection** | `scripts_01/oom_protect.sh` | Защита от Signal 9 |
...
**Ресурсы:** `freebuff://session/current`, `freebuff://context_12/last`
...
```bash
# Wrapper
python3 freebuff_plugin_03/wrapper.py launch "задача" --cwd .
python3 freebuff_plugin_03/wrapper.py status

# Bridge
python3 freebuff_plugin_03/bridge.py start
python3 freebuff_plugin_03/bridge.py end <sid>

# Scenario Engine
python3 freebuff_plugin_03/scenario_engine.py list
python3 freebuff_plugin_03/scenario_engine.py get <slug>
python3 freebuff_plugin_03/scenario_engine.py search <query>
python3 freebuff_plugin_03/scenario_engine.py apply <slug> --vars '{***REMOVED***'

# Router
python3 freebuff_plugin_03/router.py "запрос"
python3 freebuff_plugin_03/router.py -i     # интерактивный

# Servers
python3 freebuff_plugin_03/api.py           # REST на :8410
python3 freebuff_plugin_03/mcp_server.py     # MCP STDIO
...
```json
{
  "mcpServers": {
    "freebuff-plugin": {
      "command": "python3",
      "args": [".../freebuff_plugin_03/mcp_server.py"***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
```
...
| Документ | Описание |
|----------|----------|
| `docs_10/FREEBUFF_PLUGIN_ARCHITECTURE.md` | Полная архитектура системы |
| `docs_10/FREEBUFF_PLUGIN_API.md` | REST + MCP справочник |
| `docs_10/FREEBUFF_PLUGIN_QUICKSTART.md` | Быстрый старт |
