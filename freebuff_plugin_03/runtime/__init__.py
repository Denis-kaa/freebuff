...
Спецификация: docs_10/core/RUNTIME_ABSTRACTION_SPECIFICATION.md
...
if TYPE_CHECKING:
    from freebuff_plugin_03.runtime.registry import RuntimeCapabilityRegistry, RuntimeRegistry
...
def __getattr__(name: str) -> Any:
    if name == "RuntimeRegistry":
        from freebuff_plugin_03.runtime.registry import RuntimeRegistry
