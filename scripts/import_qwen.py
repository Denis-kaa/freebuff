...
Использование:
    ...
    python scripts/import_qwen.py --memories-only
    python scripts/import_qwen.py --history-only
"""
...
QWEN_HOME = Path("/data/data/com.termux/files/home/.qwen")
...
def import_projects(cm: ContextManager) -> List[str***REMOVED***:
    ...
    projects_dir = QWEN_HOME / "projects"
