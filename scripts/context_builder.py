...
Использование:
    python scripts/context_builder.py                 # полный контекст в stdout
    python scripts/context_builder.py --levels working,project  # только указанные уровни
    python scripts/context_builder.py --save unified_context.md  # сохранить в файл
    python scripts/context_builder.py --status       # статистика контекста
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Примеры:
  python scripts/context_builder.py                          # полный контекст
  python scripts/context_builder.py --levels working,project # только память
  python scripts/context_builder.py --save ctx.md            # сохранить в файл
  python scripts/context_builder.py --status                 # статистика
  python scripts/context_builder.py --no-session             # без сессии
        """,
    )
    parser.add_argument(
        "--levels", default="",
