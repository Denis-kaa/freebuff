...
CLI:
    python scripts/roles.py list                         # все назначения
    python scripts/roles.py get buffy                    # роли агента
    python scripts/roles.py assign buffy developer      # назначить роль
    python scripts/roles.py unassign buffy developer    # отозвать роль
    python scripts/roles.py by-role developer           # агенты по роли
"""
...
ROLES_DB = WORKSPACE / "data" / "roles.db"
