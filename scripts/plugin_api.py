...
самостоятельные Python-пакеты в директории plugins/, которые могут:
...
Архитектура:
  PluginLoader
  ├── discover()        — сканирует plugins/ на наличие плагинов
...
class PluginLoader:
    ...
    Сканирует директорию plugins/, находит поддиректории с
