...
Использование из кода:
    from scripts.buffy_stream_logger import log_assistant, log_user
    log_assistant("Рассказал пользователю о StreamBridge.")

CLI:
    python scripts/buffy_stream_logger.py "Текст ответа ассистента"
    python scripts/buffy_stream_logger.py --role user "Текст запроса"
    echo "Текст ответа" | python scripts/buffy_stream_logger.py --role assistant
"""
