...
CLI:
    python scripts/collaboration.py list                          # все сессии
    python scripts/collaboration.py get <session_id>              # детали сессии
    python scripts/collaboration.py create "Тема" --participants a,b
    python scripts/collaboration.py close <session_id>
    python scripts/collaboration.py send <session_id> buffy "текст"
    python scripts/collaboration.py history <session_id>
    python scripts/collaboration.py status                        # диагностика
"""
...
COLLAB_DB = WORKSPACE / "data" / "collaboration.db"
