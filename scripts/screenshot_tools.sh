...
#
# Использование:
#   bash scripts/screenshot_tools.sh              — последние 5 скриншотов
#   bash scripts/screenshot_tools.sh last         — последний
#   bash scripts/screenshot_tools.sh list [N***REMOVED***     — последние N
#   bash scripts/screenshot_tools.sh info [file***REMOVED***  — детали файла
#   bash scripts/screenshot_tools.sh copy         — скопировать последний в /tmp
# ============================================================
