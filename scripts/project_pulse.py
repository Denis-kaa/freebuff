...
CLI:
    python scripts/project_pulse.py list          # лента
    python scripts/project_pulse.py list --limit 20
    python scripts/project_pulse.py stats         # статистика
    python scripts/project_pulse.py scan          # полное сканирование
"""
...
PULSE_DB = WORKSPACE / "data" / "project_pulse.db"
