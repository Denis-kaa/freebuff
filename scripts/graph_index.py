...
Использование:
    ...
    g = GraphIndex(Path("context/knowledge/index.db"))
...
class GraphIndex:
    ...
    def auto_discover(
        ...
        """
        from scripts.knowledge_engine import Tokenizer
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Примеры:
  python scripts/graph_index.py related doc1                    # все связи doc1
  python scripts/graph_index.py path doc1 doc5                  # кратчайший путь
  python scripts/graph_index.py subgraph doc1 --depth 3        # подграф
  python scripts/graph_index.py edge add doc1 doc2 references   # добавить ребро
  python scripts/graph_index.py auto                            # авто-детект
  python scripts/graph_index.py stats                           # статистика
        """,
    )
    ...
    from scripts.knowledge_engine import DEFAULT_DB_PATH, DEFAULT_WORKSPACE
