...
class TelegramFreebuffBot:
    """Simple Telegram frontend backed by ContextManager."""

    def __init__(self, workspace: str | Path) -> None:
        self.cm = ContextManager(str(workspace))
    ...
    def _persist_active_sessions(self) -> None:
        ...
        path = self.workspace / "data" / "telegram_bot_sessions.json"
        try:
...
def main() -> int:
    ...
    # Python 3.12+ requires an explicit event loop in the main thread
