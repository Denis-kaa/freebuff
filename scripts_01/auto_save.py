...
Использование (из Buffy):
  ...
  1. При старте сессии (один раз):
     python scripts_01/auto_save.py --start "Тема сессии"
     → сохраняет session_id в /tmp/buffy_stream.sid

  2. При каждом сообщении:
     echo "текст пользователя" | python scripts_01/auto_save.py --save-user
     echo "текст ответа" | python scripts_01/auto_save.py --save-assistant

  3. При завершении:
     python scripts_01/auto_save.py --end

  Или напрямую:
     python scripts_01/auto_save.py --save-user "текст"
     python scripts_01/auto_save.py --save-assistant "текст"
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Примеры:
  python scripts_01/auto_save.py --start "Рефакторинг TUI"
  python scripts_01/auto_save.py --save-user "Привет, сделай рефакторинг"
  python scripts_01/auto_save.py --save-assistant "Начинаю рефакторинг..."
  echo "короткий текст" | python scripts_01/auto_save.py --save-assistant
  python scripts_01/auto_save.py --end
  python scripts_01/auto_save.py --status
        """,
    )
