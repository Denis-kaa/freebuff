...
Использование:
    python scripts_01/verifier.py verify --task-id xxx --task-type refactor
    python scripts_01/verifier.py rules list
    python scripts_01/verifier.py rules add --name "Check file" --task-type refactor ...
    python scripts_01/verifier.py status --task-id xxx
"""
...
class VerificationResult:
    ...
    Attributes:
        ...
        verified_by: кто проверил ("verifier", "cli_07", "auto")
...
Примеры:
  ...
  python scripts_01/verifier.py diagnose --json
        """,
    )
