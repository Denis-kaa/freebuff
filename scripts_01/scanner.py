...
Использование:
    python scripts_01/scanner.py                    # полный скан
    python scripts_01/scanner.py --category llm     # только LLM-инструменты
    python scripts_01/scanner.py --output report.json
"""
