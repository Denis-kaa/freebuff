...
class ContextManager:
    ...
    def __init__(
        ...
        self._summaries_dir = os.path.join(workspace_root, "context_12", "summaries")
    ...
    def save_checkpoint(
        ...
        автоматический rollup-конспект в context_12/context_full_rollup.md
    ...
    def _save_context_rollup(
        ...
        Создаёт файл context_12/context_full_rollup.md, который содержит
