...
COMPETENCIES = [
    ...
    ***REMOVED***,
    {
        ...
        "category": "python_fundamentals",
        "prerequisites": ["variables"***REMOVED***,
        ...
        "typical_errors": ["integer_division_confusion", "string_plus_int"***REMOVED***,
        "verification_exercise": "currency-exchange",
        "project_marker": "Калькулятор с типичным пользовательским вводом.",
        "exercism_concepts": ["numbers", "none", "number-variations"***REMOVED***,
    ***REMOVED***,
    {
        "id": "expressions",
        ...
        "category": "python_fundamentals",
        "prerequisites": ["primitive-types"***REMOVED***,
        ...
        "typical_errors": ["operator_precedence", "chained_compare_misuse"***REMOVED***,
        "verification_exercise": "difference-of-squares",
        "project_marker": "Функция с математическими расчётами (скидка, площадь).",
        "exercism_concepts": ["comparisons", "rich-comparisons"***REMOVED***,
    ***REMOVED***,
    {
        "id": "boolean-logic",
        ...
        "category": "python_fundamentals",
        "prerequisites": ["expressions"***REMOVED***,
        "understand_criteria": "Объяснить truthiness (0, '', [***REMOVED***, None — falsy) и логику И/ИЛИ/НЕ.",
        "can_do_criteria": "Строить условия с and/or/not и скобками, упрощать сложные выражения.",
        "typical_errors": ["confusing_and_or", "truthiness_gotcha"***REMOVED***,
        "verification_exercise": "ghost-gobble-arcade-game",
        "project_marker": "Валидация входных данных с несколькими условиями.",
        "exercism_concepts": ["bools", "comparisons"***REMOVED***,
    ***REMOVED***,
    # --- control_flow ---
    {
        "id": "conditionals",
        ...
        "prerequisites": ["boolean-logic"***REMOVED***,
        ...
        "typical_errors": ["nested_ifs", "missing_default_branch"***REMOVED***,
        "verification_exercise": "log-levels",
        "project_marker": "Классификатор (например, таблица оценок).",
        "exercism_concepts": ["conditionals"***REMOVED***,
    ***REMOVED***,
    {
        "id": "loops",
        ...
        "category": "control_flow",
        "prerequisites": ["conditionals"***REMOVED***,
        ...
        "typical_errors": ["infinite_loop", "mutate_while_iterating"***REMOVED***,
        "verification_exercise": "making-the-grade",
        "project_marker": "Постраничный вывод, таблица умножения.",
        "exercism_concepts": ["loops", "iteration"***REMOVED***,
    ***REMOVED***,
    {
        "id": "comprehensions",
        ...
        "category": "control_flow",
        "prerequisites": ["loops", "lists"***REMOVED***,
        ...
        "typical_errors": ["comprehension_side_effects", "too_complex_comprehension"***REMOVED***,
        "verification_exercise": "flatten-array",
        "project_marker": "Извлечение полей из списка словарей.",
        "exercism_concepts": ["list-comprehensions", "other-comprehensions"***REMOVED***,
    ***REMOVED***,
    # --- collections ---
    {
        "id": "lists",
        ...
        "typical_errors": ["index_out_of_range", "aliasing_shared_list"***REMOVED***,
        "verification_exercise": "list-ops",
        "project_marker": "Обработка входного массива данных.",
        "exercism_concepts": ["lists", "list-methods", "sequences", "aliasing"***REMOVED***,
    ***REMOVED***,
    {
        "id": "tuples",
        "name": "Tuples",
        ...
        "typical_errors": ["try_mutate_tuple", "tuple_vs_list_confusion"***REMOVED***,
        "verification_exercise": "cater-waiter",
        "project_marker": "Возврат пары значений из функции.",
        "exercism_concepts": ["tuples"***REMOVED***,
    ***REMOVED***,
    {
        "id": "dicts",
        "name": "Dicts",
        ...
        "typical_errors": ["key_error_unhandled", "dict_where_list_misuse"***REMOVED***,
        "verification_exercise": "inventory-management",
        "project_marker": "Подсчёт, кэш, маппинг выбора.",
        "exercism_concepts": ["dicts", "dict-methods"***REMOVED***,
    ***REMOVED***,
    {
        "id": "sets",
        "name": "Sets",
    ...
    ***REMOVED***,
    # --- functions ---
    {
        ...
        "category": "functions",
        "prerequisites": ["conditionals", "loops"***REMOVED***,
        ...
        "typical_errors": ["no_return_expected", "hidden_side_effect"***REMOVED***,
        "verification_exercise": "hello-world",
        "project_marker": "CLI с функциями-шагами.",
        "exercism_concepts": ["functions", "functional-tools", "higher-order-functions", "anonymous-functions"***REMOVED***,
    ***REMOVED***,
    {
        ...
        "category": "functions",
        "prerequisites": ["functions", "tuples"***REMOVED***,
        ...
        "typical_errors": ["mutable_default_argument", "kwargs_misuse"***REMOVED***,
        "verification_exercise": "two-fer",
        "project_marker": "Функция API с параметрами по умолчанию.",
        "exercism_concepts": ["function-arguments", "unpacking-and-multiple-assignment"***REMOVED***,
    ***REMOVED***,
    {
        ...
        "category": "functions",
        "prerequisites": ["functions"***REMOVED***,
        ...
        "typical_errors": ["global_mutation", "one_long_function"***REMOVED***,
        "verification_exercise": "matching-brackets",
        "project_marker": "Рефакторинг legacy-скрипта.",
        "exercism_concepts": ["unpacking-and-multiple-assignment"***REMOVED***,
    ***REMOVED***,
    # --- strings ---
    {
        "id": "strings",
        ...
        "typical_errors": ["mutation_attempt_immutable", "heavy_concatenation"***REMOVED***,
        "verification_exercise": "reverse-string",
        "project_marker": "Формат-вывод отчёта.",
        "exercism_concepts": ["strings", "string-formatting"***REMOVED***,
    ***REMOVED***,
    {
        "id": "string-methods",
        ...
        "typical_errors": ["loop_concat_instead_join", "case_sensitive_gotcha"***REMOVED***,
        "verification_exercise": "isogram",
        "project_marker": "Парсер простого текстового формата.",
        "exercism_concepts": ["string-methods", "string-methods-splitting"***REMOVED***,
    ***REMOVED***,
    # --- exceptions ---
    {
        "id": "exceptions",
        ...
        "category": "exceptions",
        "prerequisites": ["functions", "conditionals"***REMOVED***,
        ...
        "typical_errors": ["bare_except", "swallow_exception_silently"***REMOVED***,
        "verification_exercise": "error-handling",
        "project_marker": "CLI с обработкой ввода.",
        "exercism_concepts": ["raising-and-handling-errors", "user-defined-errors"***REMOVED***,
    ***REMOVED***,
    # --- modules ---
    {
        "id": "modules",
        ...
        "typical_errors": ["import_circular", "side_effect_on_import"***REMOVED***,
        "verification_exercise": "little-sisters-vocab",
        "project_marker": "Пакет из двух модулей.",
        "exercism_concepts": [***REMOVED***,
    ***REMOVED***,
    # --- oop ---
    {
        "id": "classes",
        ...
        "category": "oop",
        "prerequisites": ["dicts", "functions"***REMOVED***,
        ...
        "typical_errors": ["self_missing", "mutable_attribute_leak"***REMOVED***,
        "verification_exercise": "ellens-alien-game",
        "project_marker": "Приложение с сущностями-объектами.",
        "exercism_concepts": ["classes", "class-customization", "dataclasses"***REMOVED***,
    ***REMOVED***,
    {
        ...
        "typical_errors": ["overuse_inheritance", "forget_super_init"***REMOVED***,
        "verification_exercise": "diamond",
        "project_marker": "Иерархия фигур (площадь/периметр).",
        "exercism_concepts": ["class-inheritance", "class-composition"***REMOVED***,
    ***REMOVED***,
    # --- files_io ---
    {
        "id": "files-io",
        ...
        "category": "files_io",
        "prerequisites": ["string-methods", "modules"***REMOVED***,
        ...
        "typical_errors": ["file_not_closed", "wrong_encoding"***REMOVED***,
        "verification_exercise": "word-count",
        "project_marker": "Утилита обработки текстового файла.",
        "exercism_concepts": ["with-statement"***REMOVED***,
    ***REMOVED***,
    # --- testing ---
    {
        "id": "testing",
        ...
        "category": "testing",
        "prerequisites": ["functions", "exceptions"***REMOVED***,
    ...
    ***REMOVED***,
    # --- code_structure ---
    {
        ...
        "prerequisites": ["functions", "scope-decomposition"***REMOVED***,
    ...
    ***REMOVED***,
    # --- дополнительные (покрытие Exercism concepts) ---
    {
        ...
        "category": "control_flow",
        "prerequisites": ["loops", "functions"***REMOVED***,
        ...
        "typical_errors": ["generator_consumed_once", "materialize_unbounded"***REMOVED***,
        "verification_exercise": "series",
        "project_marker": "Построчный обработчик файла.",
        "exercism_concepts": ["iterators", "generators", "generator-expressions", "itertools"***REMOVED***,
    ***REMOVED***,
    {
        "id": "unpacking",
        ...
        "category": "functions",
        "prerequisites": ["tuples", "function-parameters"***REMOVED***,
        ...
        "typical_errors": ["misordered_unpacking", "too_many_nested_unpacks"***REMOVED***,
        "verification_exercise": "making-the-grade",
        "project_marker": "Обработка пар значений из данных.",
        "exercism_concepts": ["unpacking-and-multiple-assignment", "walrus-operator"***REMOVED***,
    ***REMOVED***,
***REMOVED***
...
def main() -> int:
    ...
    for i, c in enumerate(COMPETENCIES):
        ...
        if missing:
            errors.append(f"[{i***REMOVED******REMOVED*** {c.get('id', '?')***REMOVED***: missing {sorted(missing)***REMOVED***")
        extra = keys - REQUIRED
        if extra:
            errors.append(f"[{i***REMOVED******REMOVED*** {c.get('id', '?' )***REMOVED***: extra keys {sorted(extra)***REMOVED***")
        if c.get("category") not in CATEGORIES:
            errors.append(f"[{i***REMOVED******REMOVED*** {c.get('id', '?')***REMOVED***: bad category {c.get('category')!r***REMOVED***")
        if not isinstance(c.get("typical_errors"), list):
            errors.append(f"[{i***REMOVED******REMOVED*** typical_errors must be list")
        if not isinstance(c.get("exercism_concepts"), list):
            errors.append(f"[{i***REMOVED******REMOVED*** exercism_concepts must be list")
        cid = c.get("id")
        if cid in ids:
            errors.append(f"[{i***REMOVED******REMOVED*** duplicate id {cid!r***REMOVED***")
        ids.add(cid)
    # Непроверенные prerequisites
    for c in COMPETENCIES:
        for p in c.get("prerequisites", [***REMOVED***):
            if isinstance(p, str) and p not in ids:
                errors.append(f"{c['id'***REMOVED******REMOVED***: unknown prerequisite {p!r***REMOVED***")
    if errors:
        for e in errors:
            print("ERROR:", e)
        return 2
    ...
    ***REMOVED***
    ...
    print(f"OK: {len(COMPETENCIES)***REMOVED*** competencies -> configs/competency_map.yaml")
    return 0
