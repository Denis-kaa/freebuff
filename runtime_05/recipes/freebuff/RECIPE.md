...
python -m pytest tests_09/ -q   # Прогнать тесты
```
...
- [COMPATIBILITY_MATRIX.md***REMOVED***(../../../docs_10/core/COMPATIBILITY_MATRIX.md)
