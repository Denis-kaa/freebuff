...
- Запускать Python-скрипты из `scripts_01/`
- Работать с SQLite-базой `data_13/context.db`
- Читать документацию из `docs_10/`
...
2. Запроси у пользователя ID сессии или создай новую:
   python scripts_01/context_manager.py
3. Найди последний конспект:
   ls freebuff/context_12/summaries/ | tail -1
```
...
### Termux AI Agent
```
- Путь: ai-engineering-pipeline/projects_17/termux-ai-agent/
...
python scripts_01/auto_conspect.py                          # суммаризация всех активных сессий
python -c "
...
cd /storage/emulated/0/PROJECTS/workstation/ai-engineering-pipeline/projects_17/termux-ai-agent
python -m pytest tests_09/ -v                          # тесты (38 шт)
