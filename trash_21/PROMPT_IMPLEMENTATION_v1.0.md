...
> **⚠️ Полный текст промпта:** см. [`pompts_11/017_02_struktura_requirements_testy.md`***REMOVED***(../../pompts_11/017_02_struktura_requirements_testy.md)  
> Этот файл — точка входа в документации. Реализация — в `freebuff_plugin_03/mesh/`.
...
ls freebuff_plugin_03/mesh/{core,node,session,agent,transport,storage***REMOVED***/

# Установить зависимости
pip install ulid-py websocket-client diff-match-patch

# Запустить тесты (когда будут написаны)
pytest tests_09/test_mesh.py -v
```

---

_Полный текст: [pompts_11/017_02_struktura_requirements_testy.md***REMOVED***(../../pompts_11/017_02_struktura_requirements_testy.md)_
