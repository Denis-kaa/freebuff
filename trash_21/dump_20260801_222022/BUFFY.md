...
├── core_02/                     # интерфейсы ядра (interfaces.py, router.py)
├── src_06/                      # пакетные модули (workers/)
├── cli_07/                      # CLI-слой
├── frontend_18/                 # фронтенд (BuffyDashboard.tsx)
├── plugins_04/                  # плагины (tg_messenger, system_monitor, …)
├── services_08/                 # сервисы (system/monitor)
├── projects_17/                 # пользовательские проекты
├── infa_20/                     # инфраструктурные материалы
├── buffy-playground_19/         # песочница для экспериментов
├── prototype_22/                # прототип UI (Project-Centric + Graph View)
├── screenshots_16/              # скриншоты
├── trash_21/                    # временный мусор
├── sessions_15/                 # сырые логи
├── logs_14/                     # системные логи
├── docs_10/
...
├── pompts_11/                   # промпты и логи сессий
├── context_12/
│   ├── checkpoints/          # чекпоинты Markdown
│   └── summaries/            # конспекты сессий
├── freebuff_plugin_03/          # плагин-обёртка для Codebuff
...
├── tests_09/                    # 1000+ тестов
├── freebuff_plugin_03/mesh/     # 🆕 Session Mesh v2.0 (распределённый слой)
├── runtime_05/                  # Marketplace-ready провайдеры
└── data_13/
...
- **Спецификация:** [docs_10/core/DISTRIBUTED_SESSION_SPECIFICATION_v2.0.md***REMOVED***(docs_10/core/DISTRIBUTED_SESSION_SPECIFICATION_v2.0.md)
- **Промпт реализации:** [pompts_11/017_02_struktura_requirements_testy.md***REMOVED***(pompts_11/017_02_struktura_requirements_testy.md) (канон; стаб-копия в docs_10/core архивирована 2026-08-01)
- **Код:** `freebuff_plugin_03/mesh/` — Node Mesh, Session Mesh, Agent Mesh
