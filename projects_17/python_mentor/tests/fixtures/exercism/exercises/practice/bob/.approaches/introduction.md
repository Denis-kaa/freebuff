...
- If the input is stripped, [`rstrip`***REMOVED***[rstrip***REMOVED*** only once.

- Use the [`endswith`***REMOVED***[endswith***REMOVED*** method instead of checking the last character by index for `?`.
...
- Don't copy/paste the logic for determining a shout and for determining a question into determining a shouted question.
  ...
  Not duplicating the code will keep the code [DRY***REMOVED***[dry***REMOVED***.
...
For more information, check the [`if` statements approach***REMOVED***[approach-if***REMOVED***.
...
For more information, check the [`if` statements nested approach***REMOVED***[approach-if-nested***REMOVED***.
...
For more information, check the [answer list approach***REMOVED***[approach-answer-list***REMOVED***.
...
- To compare the performance of the approaches, check out the [Performance article***REMOVED***[article-performance***REMOVED***.

[rstrip***REMOVED***: https://docs.python.org/3/library/stdtypes.html?highlight=rstrip#str.rstrip
[endswith***REMOVED***: https://docs.python.org/3/library/stdtypes.html?highlight=strip#str.endswith
[dry***REMOVED***: https://en.wikipedia.org/wiki/Don%27t_repeat_yourself
...
[article-performance***REMOVED***: https://exercism.org/tracks/python/exercises/bob/articles/performance
