...
Define the `EXPECTED_BAKE_TIME` [constant***REMOVED***[constants***REMOVED*** that represents how many minutes the lasagna should bake in the oven.
...
Define the `preparation_time_in_minutes()` [function***REMOVED***[functions***REMOVED*** that takes the `number_of_layers` you want to add to the lasagna as an argument and returns how many minutes you would spend making them.
...
Go back through the recipe, adding "notes" in the form of [function docstrings***REMOVED***[function-docstrings***REMOVED***.
...
[constants***REMOVED***: https://stackoverflow.com/a/2682752
[functions***REMOVED***: https://docs.python.org/3/tutorial/controlflow.html#defining-functions
[function-docstrings***REMOVED***: https://docs.python.org/3/tutorial/controlflow.html#documentation-strings
