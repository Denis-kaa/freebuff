...
[The Python comparisons tutorial***REMOVED***[python comparisons tutorial***REMOVED*** and [Python comparisons examples***REMOVED***[python comparisons examples***REMOVED*** are a great introduction covering the content of this exercise.
...
- You can use the [`int` constructor***REMOVED***[int constructor***REMOVED*** to convert a `str` of an `int` to an `int`: `int('13')`.
...
- Remember, you can use the [`if`/`elif`/`else` syntax***REMOVED***[if syntax***REMOVED*** to handle different combinations of cards.
...
- You can use the [conditional expression***REMOVED***[conditional expression***REMOVED*** (_sometimes called a "ternary operator"_)
  to shorten simple `if`/`else` statements: `13 if letter == 'M' else 3`.

[conditional expression***REMOVED***: https://docs.python.org/3/reference/expressions.html#conditional-expressions
[if syntax***REMOVED***: https://docs.python.org/3/tutorial/controlflow.html#if-statements
[int constructor***REMOVED***: https://docs.python.org/3/library/functions.html#int
[python comparisons examples***REMOVED***: https://www.tutorialspoint.com/python/comparison_operators_example.htm
[python comparisons tutorial***REMOVED***: https://docs.python.org/3/reference/expressions.html#comparisons
