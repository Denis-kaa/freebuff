...
In this exercise you are going to implement some rules of [Blackjack***REMOVED***[blackjack***REMOVED***,
...
A [standard French-suited 52-card deck***REMOVED***[standard_deck***REMOVED*** is assumed, but in most versions, several decks are shuffled together for play.
...
[blackjack***REMOVED***: https://bicyclecards.com/how-to-play/blackjack/
[standard_deck***REMOVED***: https://en.wikipedia.org/wiki/Standard_52-card_deck
