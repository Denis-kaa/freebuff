...
The goal of this exercise is to teach the student how Enums ([Enumerations***REMOVED***(https://en.wikipedia.org/wiki/Enumerated_type)) are implemented & used in Python. We will teach this through Pythons Enum class/type.
...
- [Exercism v3 C# Enums concept exercise***REMOVED***(https://github.com/exercism/v3/tree/master/languages/csharp/exercises/concept/enums)
- [Python Docs: Enum***REMOVED***(https://docs.python.org/3/library/enum.html)
- [Enum - Mouse vs. Python***REMOVED***(https://www.blog.pythonlibrary.org/2018/03/20/python-3-an-intro-to-enumerations/)
- [Why you should use more enums in Python - Florian Dahlitz***REMOVED***(https://florian-dahlitz.de/blog/why-you-should-use-more-enums-in-python)
- [Python Docs: How are Enums Different?***REMOVED***(https://docs.python.org/3/library/enum.html#how-are-enums-different)
- [Python Docs: The Enum Functional API***REMOVED***(https://docs.python.org/3/library/enum.html#functional-api)
- [Stack Overflow: Python enum, when and where to use?***REMOVED***(https://stackoverflow.com/questions/22586895/python-enum-when-and-where-to-use)
- [PEP435: Adding an Enum Type to the Python Standard Library***REMOVED***(https://www.python.org/dev/peps/pep-0435/)
- [Using Enums and Django model Choices - Ben Cleary***REMOVED***(https://medium.com/@bencleary/using-enums-as-django-model-choices-96c4cbb78b2e)
