...
| SRC-011 | **HeadHunter API — публичный поиск вакансий**: `https://api.hh.ru/vacancies` | Официальный HTTPS API, приложение одобрено (#22931); ключ → env/secret storage | Документированный OpenAPI (`api.hh.ru/openapi/redoc`); live-проверка 2026-08-23: HTTP 200, `text=python` → 6629 вакансий; поля: id, name, description, alternate_url, published_at, employment, experience, salary, area, snippet | **Evidence:**
