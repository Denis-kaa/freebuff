...
|---|---|---|---|
| pb-m01 | Мелованная стопа в разрезе (тираж) | поиск: `coated paper stack` | TODO |
| pb-m02 | Самоклейка: клей/подложка с торца | поиск: `self adhesive vinyl roll` | TODO |
| pb-m03 | Литой баннер фактура поверхности | поиск: `cast vinyl banner surface` | TODO |
| pb-m04 | Лист ПВХ 3/5/10 мм стопой (толщины) | поиск: `expanded PVC sheet` | TODO |
| pb-m05 | Акрил лист на просвет (молочный) | поиск: `acrylic sheet backlit` | TODO |
| pb-m06 | Холст фактура после печати | поиск: `printed canvas texture` | TODO |
| pb-m07 | Флажная ткань/трикетаж крупно | поиск: `polyester flag fabric` | TODO |
| pb-m08 | Фотобумага глянец vs матовая | поиск: `glossy photo paper` | TODO |
