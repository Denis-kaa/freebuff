...
· docs_10/projects_meta/LIGHTPANDA_INTEGRATION.md — полный гайд
· docs_10/projects_meta/WORKERS.md — обновить раздел с воркерами
· docs_10/vision/archive/ARCHITECTURE.md — обновить архитектурную схему
· src_06/workers/lightpanda_worker.py — код воркера
· scripts_01/install_lightpanda.sh — скрипт установки
