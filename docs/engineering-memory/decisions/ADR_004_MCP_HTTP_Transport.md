...
- [scripts/mcp_server.py***REMOVED***(../../../scripts/mcp_server.py) — McpSession, McpSessionManager, McpHttpServer, McpHTTPRequestHandler
- [tests/test_mcp_server.py***REMOVED***(../../../tests/test_mcp_server.py) — 89 тестов (53 stdio + 10 session + 26 HTTP)
