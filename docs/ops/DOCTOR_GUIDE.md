...
> **Версия:** 1.0.0
> **Дата:** 2026-07-29
> **Основание:** [promt16.md***REMOVED***(../../pompts/promt16.md) Задача 2.2

---

## Назначение

`scripts/doctor.py` — CLI-инструмент диагностики окружения Buffy.
...
```bash
python scripts/doctor.py --json > doctor_report.json
```

## Связанные документы

- [../core/COMPATIBILITY_MATRIX.md***REMOVED***(../core/COMPATIBILITY_MATRIX.md)
- [../../runtime/README.md***REMOVED***(../../runtime/README.md)
