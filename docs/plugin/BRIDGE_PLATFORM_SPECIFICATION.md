...
|-----------|------|--------|-------|
| **Bridge Layer** | `freebuff_plugin/bridge_layer.py` | ✅ Production | 60 |
| **ACP Protocol** | `freebuff_plugin/acp_protocol.py` | ✅ Production | (в составе Bridge) |
| **MCP Client** | `freebuff_plugin/mcp_client.py` | ✅ Production | (в составе Bridge) |
| **MCP Server integration** | `scripts/mcp_server.py` | ✅ Production | 89 |
| **Reverse Bridge** | — | 💡 План | — |
...
Bridge Layer — главный компонент, реализованный в `freebuff_plugin/bridge_layer.py`.
