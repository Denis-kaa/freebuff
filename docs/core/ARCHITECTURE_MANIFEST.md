...
> **Компаньоны:** [CORE_PROMPT.md***REMOVED***(CORE_PROMPT.md) (поведение агента), [CODE_QUALITY_STANDARD.md***REMOVED***(CODE_QUALITY_STANDARD.md) (качество кода), [GLOSSARY.md***REMOVED***(GLOSSARY.md) (терминология)
