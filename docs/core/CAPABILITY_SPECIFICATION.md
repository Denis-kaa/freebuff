...
class CapabilityRegistry:
    ...
    def __init__(self, storage: Optional[Path***REMOVED*** = None):
        self._storage = storage or Path("data/capabilities.json")
...
MCP tools для Capability Registry регистрируются в `scripts/mcp_server.py`
