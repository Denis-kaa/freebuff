...
| Этап 3. Архитектурный манифест | — | 🔴 Не начато |
...
- [ ***REMOVED*** Создать `docs/core/ARCHITECTURE_MANIFEST.md`
- [ ***REMOVED*** Миссия платформы, принципы, правила, границы ответственности
- [ ***REMOVED*** Манифест = главный архитектурный закон
