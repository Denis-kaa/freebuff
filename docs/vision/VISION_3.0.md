...
Ключевой принцип: **Buffy — инфраструктура, которую подключают к Claude/Cursor/Codebuff, чтобы они стали умнее,記憶ливее и команднее.**
...
## 7. Что уже реализовано (из 25 концепций promt14.md)
...
Из 17 требуемых артефактов promt14.md готовы:
...
| 9 | **OPEN QUESTIONS** | 💡 TODO | `docs/OPEN_QUESTIONS.md` |
