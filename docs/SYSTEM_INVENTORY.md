...
### 🟢 `scripts/import_sessions.py` — Импорт истории
- Источники: OpenClaw (JSONL), Aider (Markdown), last_context.txt
- **Статус:** ✅ Production

### 🟢 `scripts/import_qwen.py` — Импорт Qwen IDE
- Memories → сессия, File-history → сессии, Projects → метаданные
- **Статус:** ✅ Production

### 🟢 `scripts/phone_mcp_server.py` — MCP-сервер телефона
...
### 🟢 `docs/SESSION_GUIDE.md` — Инструкция по сессиям
### 🟢 `docs/AGENTS.md` — Для чат-ботов
### 🟢 `docs/REFERENCES.md` — Источники
### 🟢 `docs/TROUBLESHOOTING.md` — Решение проблем
### 🟢 `docs/AUDIT_2026-07-27.md` — Аудит системы
### 🟢 `docs/ARCHITECTURE_REVIEW.md` — Архитектурный обзор
### 🟢 `docs/OVERLAY_IMPLEMENTATION.md` — Документация оверлея
### 🟢 `docs/TERMINAL_AI_STUDIO_MOBILE.md` — Flutter-видение
### 🟢 `docs/TASK_TEMPLATE.md` — Шаблон задачи 🆕
...
| Model Router — подключение локальной Qwen | 🟡 Средний | 🔴 План (Фаза 1) |
