...
termux-notification --title "TG" --content "Новое сообщение" --action "bash scripts/tg_popup.sh"
```
...
|--------|------|----------|
| tg-terminal-toolkit | `projects/tg_terminal_messenger/` | Telegram TUI клиент |
| FreeBuff Overlay | `scripts/overlay_server.py` | Плавающий мониторинг агента |
