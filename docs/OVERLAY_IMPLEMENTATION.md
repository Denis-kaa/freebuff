...
|------|-----------|--------|
| `scripts/overlay_server.py` | IPC-сервер статуса агента | ✅ Работает |
| `scripts/overlay_client.py` | Клиент для отправки статуса | ✅ Работает |
| `scripts/overlay_float.sh` | Запуск через Termux:Float/tmux | ✅ Работает |
| `scripts/tg_popup.sh` | **Telegram Popup Overlay** | ✅ Основной |
...
bash scripts/tg_popup.sh

# FreeBuff Overlay
bash scripts/overlay_float.sh
```

---

_Подробнее: docs/REFERENCES.md_
