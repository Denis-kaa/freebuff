...
from freebuff_plugin.acp_protocol import (
...
from freebuff_plugin.bridge_layer import BridgeLayer, BridgeMCPServer
from freebuff_plugin.mcp_client import (
...
class TestBridgeLayer:
    ...
    def test_connect_and_disconnect_mcp_stdio(self, bridge: BridgeLayer):
        ...
        ***REMOVED***
        ...
        with patch("freebuff_plugin.bridge_layer.StdioMCPClient", return_value=mock_client):
    ...
    def test_connect_mcp_http(self, bridge: BridgeLayer):
        ...
        with patch("freebuff_plugin.bridge_layer.HTTPMCPClient", return_value=mock_client):
