"""
Тесты для MCP event инструментов в freebuff_plugin/mcp_server.py.
...
from freebuff_plugin.event import AuditDecision, AuditAction
...
def server() -> Generator[Any, None, None***REMOVED***:
    ...
    with patch("freebuff_plugin.mcp_server.plugin_bridge"), \
         patch("freebuff_plugin.mcp_server.plugin_wrapper"), \
         patch("freebuff_plugin.mcp_server.ScenarioEngine"):
        from freebuff_plugin.mcp_server import MCPServer
        srv = MCPServer()
        yield srv
