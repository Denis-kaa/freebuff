...
from freebuff_plugin.bootstrap import (
    BootstrapProfile,
    BootstrapReport,
    DiagnosticReport,
    EnvironmentState,
...
from freebuff_plugin.bootstrap.checker import EnvironmentChecker
from freebuff_plugin.bootstrap.state import BootstrapState
from freebuff_plugin.bootstrap.installer import IdempotentInstaller
from freebuff_plugin.bootstrap.doctor import RuntimeDoctor
...
class TestProfiles:
    ...
    def test_default_profiles_exist(self):
        ...
        yaml_path = Path(WORKSPACE) / "freebuff_plugin" / "bootstrap" / "profiles.yaml"
...
class TestBootstrapEngine:
    ...
    def test_load_profile_fallback(self, tmp_ws: Path):
        ...
        with patch("freebuff_plugin.bootstrap.engine.DEFAULT_PROFILES_PATH",
