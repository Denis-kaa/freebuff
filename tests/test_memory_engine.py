"""
Tests for scripts/memory_engine.py — Memory Engine.
"""
...
class TestMemoryEngineDelete:
    ...
    def test_delete_existing(self, engine):
        engine.store(MemoryLevel.WORKING, "to_delete", "data")
    ...
    def test_delete_wrong_level(self, engine):
        engine.store(MemoryLevel.PROJECT, "shared_key", "data")
...
class TestMemoryEngineStats:
    ...
    def test_count_entries(self, engine):
        ...
        engine.store(MemoryLevel.WORKING, "x", "data")
