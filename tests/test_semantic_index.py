#!/usr/bin/env python3
"""
Tests for Semantic Index (torch SVD LSA) in scripts/knowledge_engine.py.
"""
...
from scripts.knowledge_engine import (
...
class TestSemanticIndex:
    ...
    def test_fit_creates_embeddings(self, tmp_workspace: Path):
        ...
        vocab = {"router": 0, "memory": 1, "context": 2, "engine": 3***REMOVED***
        ...
        si.fit(vectors, ["router", "memory", "context"***REMOVED***, vocab, n_components=2)
    ...
    def test_clear(self, tmp_workspace: Path):
        ...
        si.clear()
        assert si.is_empty()
        assert not (tmp_workspace / "context" / "knowledge" / "svd_u.npy").exists()
