...
from freebuff_plugin.config import MCP_SERVER_NAME, MCP_SERVER_VERSION
        ...
        try:
            if name == "start_session":
                ...
                ***REMOVED***
                ...
                from freebuff_plugin.event import EventQuery
                query = EventQuery(
                ...
                ***REMOVED***
                ...
                store = self._get_event_store()
                from freebuff_plugin.event import EventQuery
                from freebuff_plugin.event.replay import EventReplay
    ...
    def _read_resource(self, uri: str) -> str | None:
        if uri == "freebuff://session/current":
            return json.dumps({
                ...
                "session_id": self._session_id,
            ***REMOVED***, ensure_ascii=False)
        elif uri == "freebuff://context/last":
            bridge = plugin_bridge.get_stream_bridge()
