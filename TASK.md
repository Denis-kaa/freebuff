...
- **Note (2026-09-05, ADR-022):** межузловая синхронизация кодовой базы решена независимо от TG-Relay на уровне git-треугольника телефон ↔ GitHub ↔ whimco (правило Server-first, PROJECT_RULES §5.1; operational: `docs_10/runbook/SYNC_RUNBOOK.md`). Полный треугольник поднят и проверен живой сессией 2026-09-05 (head `9dbae43` на всех трёх узлах).
