...
| `ROADMAP_2026_2027.md` | ACTIVE | **v1.0 (2026-08-24)**: 6-9 месяцев roadmap (Phase 6-10: Production Hardening → Web UI MVP → Cowork Mode → Teamwork Mode → Flutter Mobile). North Star Metric: "1 пользователь 30+ дней без критических сбоев". Success metrics, risks, immediate steps. FBM (Legacy TUI) добавлен как альтернатива. |
