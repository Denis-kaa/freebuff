...
| 10 | **Event Platform** | ✅ Реализовано | `EVENT_PLATFORM_SPECIFICATION.md` | `freebuff_plugin_03/event/` | **61** | Event Bus |
...
|-----------|--------|----------|
| **Event Bus** | ✅ Production | `scripts_01/event_bus.py` — publish/subscribe, wildcard, SQLite лог, ~20 тестов |
...
VISION_3.0.md
  └── ARCHITECTURE_3.0.md
        ...
        └── EVENT_PLATFORM_SPECIFICATION.md
              └── freebuff_plugin_03/event/* (61 тестов) ←── Event Bus
