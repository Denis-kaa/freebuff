...
|---|------|------|-----|--------|
| 1 | Core (interfaces, router) | `core_02/interfaces.py`, `core_02/router.py` | ~300 | 9/10 |
...
### 1. Архитектура (9/10)
- **Model-Agnostic** — LLM сменный, ядро не зависит от модели (как в 003_01_buffy_2_agentic_platform.md "конституция")
