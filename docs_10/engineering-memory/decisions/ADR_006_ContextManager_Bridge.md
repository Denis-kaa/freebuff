...
Выбран **вариант C**: `scripts_01/agent_context_bridge.py` как singleton-мост. Он:
...
- [scripts_01/agent_context_bridge.py***REMOVED***(../../../scripts_01/agent_context_bridge.py)
- [tests_09/test_agent_context_bridge.py***REMOVED***(../../../tests_09/test_agent_context_bridge.py)
