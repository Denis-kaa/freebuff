...
- [scripts_01/mcp_fastapi.py***REMOVED***(../../../scripts_01/mcp_fastapi.py) — FastAPI app + CLI + tunnel
- [tests_09/test_mcp_fastapi.py***REMOVED***(../../../tests_09/test_mcp_fastapi.py) — 35 тестов
