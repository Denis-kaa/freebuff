...
3. docs_10/*.md — консистентность, устаревшие разделы
...
3. Наличие тестов в tests_09/ с тестами, описанными в спецификациях
...
Формат:
{module***REMOVED***
  ├── {dependency1***REMOVED*** ({type: core_02/extension/lab***REMOVED***)
  │     ├── {sub_dep1***REMOVED***
  │     └── {sub_dep2***REMOVED***
  ├── {dependency2***REMOVED***
  └── {dependency3***REMOVED***
...
5. **Правила коммитов** — Conventional Commits (feat/fix/docs_10/refactor)
...
Формат: Markdown документ в docs_10/knowledge/{module***REMOVED***.md
...
Структура:
```
freebuff_plugin_03/{category***REMOVED***/{module***REMOVED***/
...
*Связанные документы: [BOOTSTRAP_SPECIFICATION.md***REMOVED***(../core/BOOTSTRAP_SPECIFICATION.md), [EVENT_PLATFORM_SPECIFICATION.md***REMOVED***(../core/EVENT_PLATFORM_SPECIFICATION.md), [freebuff_plugin_03/scenarios/***REMOVED***(../../freebuff_plugin_03/scenarios), [PROMPT_BASE.md***REMOVED***(PROMPT_BASE.md)*
