...
**freebuff AI-агент для Android (Termux) с модульной архитектурой.**
...
Использует **freebuff LLM** (Qwen 2.5 0.5B через `llama-cli`) — никаких облачных API, полная автономность на устройстве.
