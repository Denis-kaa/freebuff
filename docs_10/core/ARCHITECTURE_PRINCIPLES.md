...
- `runtime_05/providers/` — YAML-манифесты (добавление Runtime без изменения кода)
- `runtime_05/plugins/` — Python-расширения (нестандартные протоколы)
- `runtime_05/recipes/` — человекочитаемые инструкции
...
См. [MARKETPLACE.md***REMOVED***(../../runtime_05/MARKETPLACE.md).
