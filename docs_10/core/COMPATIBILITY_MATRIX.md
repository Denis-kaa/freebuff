...
> **Основание:** [016_02_arhitektura_reorganizaciya.md***REMOVED***(../../pompts_11/016_02_arhitektura_reorganizaciya.md), [RUNTIME_VALIDATION_FRAMEWORK.md***REMOVED***(RUNTIME_VALIDATION_FRAMEWORK.md)
...
|---------|-----------|---------|--------|-------------|---------------|--------|
| **FreeBuff CLI** | Android/Termux | **4** — Stable | [Recipe***REMOVED***(../../runtime_05/recipes/freebuff/RECIPE.md) | Только Termux, ARM64 | 2026-07-29 | ✅ 1143 теста |
| **Claude Code** | Android/Termux | **2** — Запускается вручную | [Recipe***REMOVED***(../../runtime_05/recipes/claude_code/RECIPE.md) | Требует Node.js, npm, proot | 2026-07-29 | ⚠️ Только stdio |
