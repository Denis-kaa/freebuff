...
> **Версия:** 3.0.0  
> **Дата:** 2026-07-29  
> **Статус:** LEGACY — заменён на [ARCHITECTURE_CANONICAL.md***REMOVED***(ARCHITECTURE_CANONICAL.md) + [ARCHITECTURE_MANIFEST.md***REMOVED***(ARCHITECTURE_MANIFEST.md) (см. [DOCUMENT_REGISTRY.md***REMOVED***(../DOCUMENT_REGISTRY.md))  
...
|-----------|-----------|--------|-------|
| **ContextManager** | `scripts_01/context_manager.py` | ✅ Production | ~15 (в test_freebuff.py) |
| **StreamSession** | `scripts_01/stream_session.py` | ✅ Production | ❌ Нет отдельного теста |
| **StreamBridge** | `scripts_01/stream_bridge.py` | ✅ Production | ❌ Нет отдельного теста |
| **AutoConspect** | `scripts_01/auto_conspect.py` | ✅ Production | ✅ Есть тесты |
| **Bootstrap** | `scripts_01/bootstrap.py` | ✅ Production | ✅ Есть тесты |
...
User/Agent → StreamBridge → StreamSession → SQLite + Files
                │
                ▼
          AutoConspect → context_12/summaries/
                │
                ▼
          ContextManager → data_13/context.db
```
...
| Компонент | Класс/Файл | Статус | Тесты |
|-----------|-----------|--------|-------|
| **Memory Engine** | `scripts_01/memory_engine.py` | ✅ Production | ~15 |
| **Knowledge Engine** | `scripts_01/knowledge_engine.py` | ✅ Production | 42 |
| **Graph Index** | `scripts_01/graph_index.py` | ✅ Production | 42 |
| **Semantic Index** | `scripts_01/graph_index.py` (SemanticIndex) | ✅ Production | 15 |
| **Seed Knowledge** | `scripts_01/seed_knowledge.py` | ✅ Production | ✅ |
...
| Компонент | Класс/Файл | Статус | Тесты |
|-----------|-----------|--------|-------|
| **Event Bus** | `scripts_01/event_bus.py` | ✅ Production | ~20 |
| **Event Subscribers** | `scripts_01/event_subscribers.py` | ✅ Production | 4 |
| **Event Log** | SQLite (`context_12/events.db`) | ✅ Production | — |
...
|-----------|------|--------|-------|
| **ScenarioEngine** | `freebuff_plugin_03/scenario_engine.py` | ✅ Production | 83 |
| **11 сценариев** | `freebuff_plugin_03/scenarios/*.md` | ✅ Production | — |
| **TG Bot** | `freebuff_plugin_03/tgbot.py` | ✅ Production | 44 |
| **API endpoints** | `freebuff_plugin_03/api.py` | ✅ Production | ❌ Нет тестов API |
...
| **freebuff_plugin_03/monitor.sh** — мониторинг PID/PREFIX | ✅ Production |
| **freebuff_plugin_03/wrapper.py** — _run_oom_protection в launch() | ✅ Production |
...
External Agent (Claude/Cursor)
    │
    ▼
MCP Server (scripts_01/mcp_server.py)
    │
