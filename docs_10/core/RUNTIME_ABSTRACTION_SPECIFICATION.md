...
> **Основание:** [VISION_3.0.md***REMOVED***(../vision/VISION_3.0.md), [ARCHITECTURE_3.0.md***REMOVED***(ARCHITECTURE_3.0.md), [014_02_leviathan_arhitektura.md***REMOVED***(../../pompts_11/014_02_leviathan_arhitektura.md) (концепция #3)  
...
либо RAL и Bridge Platform должны быть объединены под общей `freebuff_plugin_03/`.
...
class RuntimeRegistry:
    ...
    def __init__(self, storage: Optional[Path***REMOVED*** = None):
        ...
        self._storage = storage or Path("data_13/runtime_registry.json")
...
MCP tools для Runtime Abstraction Layer регистрируются в `scripts_01/mcp_server.py`
