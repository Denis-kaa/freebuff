...
~/.local/bin/freebuff (bash v4)
    ...
    │   ├── bash scripts_01/oom_protect.sh --check
...
│  └─ raw.jsonl                                 │
│                                               │
│  PID: /tmp/.freebuff_plugin_03/                  │
│  ├─ pid_{sid***REMOVED***                                 │
│  └─ tmux_{sid***REMOVED***                                │
└──────────────────────────────────────────────┘
    │
    │  auto_conspect() → конспект в
    ▼  context_12/summaries/conspect_{topic***REMOVED***_{date***REMOVED***.md
```
...
| REST эндпоинтов | 10 |
| Сценариев | 7 |
| PID-файлов | в `/tmp/.freebuff_plugin_03/` |
