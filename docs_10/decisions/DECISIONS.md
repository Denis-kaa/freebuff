...
|----|----------|------|--------|--------|
| ADR-009 | Правило 11 User-Choice Override + уточнение DPE (promt37) встроены в GLOSSARY/MANIFEST | 2026-08-01 | ✅ Принято | [ADR_009_Consolidation_Promt37_User_Choice_Override.md***REMOVED***(../engineering-memory/decisions/ADR_009_Consolidation_Promt37_User_Choice_Override.md) |
| ADR-008 | Канонические правила Workspace OS (promt36) встроены в GLOSSARY/MANIFEST | 2026-08-01 | ✅ Принято | [ADR_008_Consolidation_Promt36_Canonical_Rules.md***REMOVED***(../engineering-memory/decisions/ADR_008_Consolidation_Promt36_Canonical_Rules.md) |
